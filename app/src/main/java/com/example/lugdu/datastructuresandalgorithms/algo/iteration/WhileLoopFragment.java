...
public class WhileLoopFragment extends Fragment {
    ...
    public HashMap<Integer, Fragment> getViewFragments(){
        ...
        String[] strArr = getResources().getStringArray(R.array.while_loop);
        ...
        bundle1.putInt("image", R.drawable.while1);
        ...
        bundle2.putInt("image", R.drawable.while2);
        ...
        bundle3.putInt("image", R.drawable.while3);
