...
public class StringConcatFragment extends Fragment {
    View view;
    String arr[];
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_string_concat, container, false);


        final Button button1 = view.findViewById(R.id.button1);
        /*final EditText*/ editText = view.findViewById(R.id.firstText);
        /*final EditText*/ secondInputBox = view.findViewById(R.id.secondText);
